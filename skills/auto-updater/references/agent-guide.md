...
CLAWDBOT_VERSION_BEFORE=$(openclaw --version 2>/dev/null || echo "unknown")
...
# Capture new version
CLAWDBOT_VERSION_AFTER=$(openclaw --version 2>/dev/null || echo "unknown")

# Update skills
log "Updating skills via ClawdHub..."
SKILL_OUTPUT=$(clawhub update --all 2>&1) || true
...
echo "openclaw_before: $CLAWDBOT_VERSION_BEFORE"
echo "openclaw_after: $CLAWDBOT_VERSION_AFTER"
